...
export function createDefaultQueryState(overrides: Partial<PokemonListQueryState> = {}): PokemonListQueryState {
  return {
    ...DEFAULT_QUERY_STATE,
    ...overrides,
  };
...
export function sanitizeTypes(values: readonly (string | PokemonTypeValue)[] | null | undefined): PokemonTypeValue[] {
