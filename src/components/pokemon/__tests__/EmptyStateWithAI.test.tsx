...
describe("EmptyStateWithAI", () => {
  ...
  it("should render with both custom title and description", () => {
    render(<EmptyStateWithAI {...defaultProps} title="Custom Title" description="Custom Description" />);
  ...
  it("should render with empty string description", () => {
    ...
    const descriptionParagraph = Array.from(paragraphs).find((p) => p.className.includes("max-w-xl"));
