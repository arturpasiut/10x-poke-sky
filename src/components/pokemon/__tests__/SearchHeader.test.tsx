...
describe("SearchHeader", () => {
  it("wyświetla liczbę wyników i reaguje na wpisywanie tekstu", async () => {
    ...
    render(<SearchHeader search="" total={150} onSearchChange={handleChange} onSubmit={vi.fn()} onReset={vi.fn()} />);
  ...
  it("wywołuje submit i reset przy odpowiednich akcjach", async () => {
    ...
    render(
      <SearchHeader search="mew" total={0} onSearchChange={vi.fn()} onSubmit={handleSubmit} onReset={handleReset} />
    );
