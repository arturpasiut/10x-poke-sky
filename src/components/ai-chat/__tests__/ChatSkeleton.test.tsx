...
describe("ChatSkeleton", () => {
  ...
  it("should render 2 card skeletons in grid for initial variant", () => {
    ...
    // Two cards: h-32
    const cards = Array.from(container.querySelectorAll("div")).filter((el) => el.className.includes("h-32"));
  ...
  it("should not render grid in response variant", () => {
    ...
    const grid = Array.from(container.querySelectorAll("div")).find((el) => el.className.includes("grid"));
  ...
  it("should have animate-pulse class on all skeleton elements", () => {
    ...
    const animatedElements = Array.from(container.querySelectorAll("div")).filter((el) =>
  ...
  it("should use color-mix background for shimmer effect", () => {
    ...
    const skeletonElements = Array.from(container.querySelectorAll("div")).filter((el) =>
      el.className.includes("bg-[color:color-mix")
    );
  ...
  it("should have rounded-xl corners on skeleton elements", () => {
    ...
    const roundedElements = Array.from(container.querySelectorAll("div")).filter((el) =>
  ...
  it("should have different heights between variants", () => {
    ...
    const initialContent = Array.from(initialContainer.querySelectorAll("div")).find((el) =>
      el.className.includes("h-28")
    );
    const responseContent = Array.from(responseContainer.querySelectorAll("div")).find((el) =>
