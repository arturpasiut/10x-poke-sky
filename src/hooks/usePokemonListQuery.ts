...
import {
  ...
  toPokemonSummaryViewModel,
} from "@/lib/pokemon/transformers"
import type {
  ApiError,
  PaginationViewModel,
...
function resolveNetworkError(error: unknown): ApiError {
  ...
  const fallbackMessage = offline ? "Brak połączenia z siecią. Sprawdź swoje połączenie." : "Nie udało się połączyć z serwerem."
